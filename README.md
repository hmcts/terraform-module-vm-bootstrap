...
| <a name="input_dynatrace_custom_hostname"></a> [dynatrace\_custom\_hostname](#input\_dynatrace\_custom\_hostname) | Manually set the hostname of the vm on the web interface. | `string` | `null` | no |
