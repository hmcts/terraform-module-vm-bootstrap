function Install-SplunkUF {
    ...
    # Setup
    $installerURI = 'https://download.splunk.com/products/universalforwarder/releases/9.1.0.1/windows/splunkforwarder-9.1.0.1-77f73c9edb85-x64-release.msi'
    $installerFile = $env:Temp + "\splunkforwarder-9.1.0.1-77f73c9edb85-x64-release.msi"
